<?php
    if(!isset($_GET['language']) || !isset($_GET['lang-code']) || !isset($_GET['type'])){
...
<head>
    ...
    <meta name="keyword" content="<?php echo $_GET['language']." ".$_GET['type'] ; ?>, Free <?php echo $_GET['language']." ".$_GET['type'] ; ?>, Download <?php echo $_GET['language']." ".$_GET['type'] ; ?> Free , Watch <?php echo $_GET['language']." ".$_GET['type'] ; ?> Free , Godfather.vip">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php
            ...
            $api = 'https://api.themoviedb.org/3/discover/'.$type.'?api_key=b7921279f7ccce7fec7a0950f5da561a&with_original_language='.$_GET['lang-code'];
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="search-wrapper">
                            <h2 class="mb-3"><?php echo $movie['total_pages']*20; ?>+ <?php echo $_GET['type']; ?> found for "<?php echo str_replace(["-",'and'],[" ","&"],$_GET['language']); ?>".</h2>
       ...
       <?php
            ...
            for($j=$page;$j<$movie['total_pages'];$j++){
                ...
                $api = 'https://api.themoviedb.org/3/discover/'.$type.'?api_key=b7921279f7ccce7fec7a0950f5da561a&with_original_language='.$_GET['lang-code'].'&page='.$j;
                $movie = json_decode(file_get_contents($api),true);
       ?>
        <!-- slider wrapper -->
        ...
        <nav aria-label="Page navigation example">
            <?php
                ...
                $link = "language.php?language=".$_GET['language']."&lang-code=".$_GET['lang-code']."&type=".$_GET['type']."&page="; 
            ?>
