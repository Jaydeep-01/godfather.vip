<?php
    if(!isset($_GET['category']) || !isset($_GET['ids']) || !isset($_GET['type'])){
...
<head>
    ...
    <meta name="keyword" content="<?php echo str_replace(["-",'and'],[" ","&"],$_GET['category'])." ".$_GET['type'] ; ?>, Latest <?php echo str_replace(["-",'and'],[" ","&"],$_GET['category'])." ".$_GET['type'] ; ?>">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php
            ...
            $api = 'https://api.themoviedb.org/3/discover/'.$type.'?api_key=b7921279f7ccce7fec7a0950f5da561a&with_original_language=en&with_genres='.$_GET['ids'].'&release_date.lte='.date('Y-m-d');
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="search-wrapper">
                            <h2 class="mb-3"><?php echo $movie['total_pages']*20; ?>+ <?php echo $_GET['type']; ?> found for "<?php echo str_replace(["-",'and'],[" ","&"],$_GET['category']); ?>".</h2>
                        </div>
                    </div>
                </div>
            </div>
       ...
       <?php
            ...
            for($j=$page;$j<$movie['total_pages'];$j++){
                ...
                $api = 'https://api.themoviedb.org/3/discover/'.$type.'?api_key=b7921279f7ccce7fec7a0950f5da561a&with_original_language=en&with_genres='.$_GET['ids'].'&release_date.lte='.date('Y-m-d').'&page='.$j;
       ...
       ?>
        ...
        <nav aria-label="Page navigation example">
            <?php
                ...
                $link = "category.php?category=".$_GET['category']."&type=".$_GET['type']."&ids=".$_GET['ids']."&page="; 
            ?>
            <ul class="pagination pagination-lg justify-content-center">
                ...
                <li class="page-item <?php if($page_nav != 1 && $j != $movie['total_pages']){ echo 'active'; } ?>">
                ...
                <li class="page-item <?php if($j >= $movie['total_pages'] && $page_nav != 1 && $j < $movie['total_pages']){ echo 'active'; } ?>">
