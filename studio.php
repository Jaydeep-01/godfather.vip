...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php
            ...
            $api = $studio[$_GET['id']]['url'];
                
            $url_components = parse_url($api);
            parse_str($url_components['query'], $params);
            $company_id = substr($params['with_companies'], 0, strpos($params['with_companies'], '|'));


            $network = "https://api.themoviedb.org/3/company/".$company_id."?api_key=b7921279f7ccce7fec7a0950f5da561a";
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="search-wrapper">
                            <h2 class="mb-3"><?php echo $movie['total_results']; ?>+ <?php echo $_GET['type']; ?> found for "<?php echo str_replace(["-",'and'],[" ","&"],$_GET['studio']); ?>".</h2>
       ...
       ?>
        ...
        <nav aria-label="Page navigation example">
            <?php
                ...
                $link = "studio.php?studio=".$_GET['studio']."&type=".$_GET['type']."&id=".$_GET['id']."&page="; 
            ?>
